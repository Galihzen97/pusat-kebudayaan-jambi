            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-contents">
                        <h4 class="breadcrumb-contents-title"> {{$title}} Details </h4>
                        <ul class="breadcrumb-contents-list list-style-none">
                            <li class="breadcrumb-contents-list-item"> <a href="{{route('home')}}"
                                    class="breadcrumb-contents-list-item-link"> Beranda </a> </li>
                            <li class="breadcrumb-contents-list-item text-primary"> {{$title}} Details </li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="blog-details-wrapper">
                            <div class="single-blog-details">
                                <div class="single-blog-details-content pt-0">
                                    <h2 class="single-blog-details-content-title fw-500"> {{ucwords(strtolower($event->judul))}} </h2>
                                    <div class="single-blog-details-content-tags mt-3">
                                        <span class="single-blog-details-content-tags-item"> <a href="javascript:void(0)">
                                            {{ucwords(strtolower($event->penulis))}} </a> </span>
                                        <span class="single-blog-details-content-tags-item">  {{readAgo($event->created_at)}} </span>
                                    </div>
                                    <div class="single-blog-details-thumb mt-4">
                                        <img class="radius-5"  src="{{asset($event->gambar)}}" alt="">
                                    </div>
                                    <p class="single-blog-details-content-para mt-4"> {!!$event->konten !!}</p>
