                ...
                <div class="col-xxl-4 col-lg-4 col-md-6">
                    <div class="single-blog">
                        <div class="single-blog-thumbs">
                            <a href="{{ route('detailOaseInfografis', 1) }}"> <img class="lazyloads" src="/front/assets/img/blog/blog1.jpg" alt="">
                            </a>
                        </div>
                        <div class="single-blog-contents mt-3">
                            ...
                            <h4 class="single-blog-contents-title mt-3"> <a href="{{ route('detailOaseInfografis', 1) }}"> [Judul] </a> </h4>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-lg-4 col-md-6">
                    <div class="single-blog">
                        <div class="single-blog-thumbs">
                            <a href="{{ route('detailOaseInfografis', 1) }}"> <img class="lazyloads" src="/front/assets/img/blog/blog1.jpg"
                                    alt=""> </a>
                        </div>
                        <div class="single-blog-contents mt-3">
                            <div class="single-blog-contents-tags mt-3">
